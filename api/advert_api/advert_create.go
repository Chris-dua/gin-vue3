...
func (AdvertApi) AdvertCreateView(context *gin.Context) {
	...
	if err == nil {
		res.FailWithMessage("该广告已存在", context)
		return
	}
	...
	if err != nil {
		...
		res.FailWithMessage("添加广告失败", context)
		return
	}
	res.OkWithMessage("添加广告成功", context)
